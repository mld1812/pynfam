...
override_settings = {
 ...
 'fam' : { 'two_body_current_mode': 111002 #digit 4: GT, digit 5: P, digit 6: PS0; 1 = 2bc, 2 = DME for P/PS0. 2nd digit controls GT: use 1 for full pnfam, 4 for DME
