...
pynfam_inputs = {
 'directories': {
     ...
     'outputs' : 'pynfam_test_Gd162_GT_2bc',
...
override_settings = {
 ...
 'fam' : { 'two_body_current_mode': 111100 #digit 4: GT, digit 5: P, digit 6: PS0; 1 = 2bc, 2 = DME for P/PS0. 2nd digit controls GT: use 1 for full pnfam, 4 for DME
 #		
 	   #'max_iter' : 2
