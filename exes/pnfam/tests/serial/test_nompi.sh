...
test_input_ctr1=default_contour_gt0.in
test_input_ctr2=default_contour_gt1.in
test_input_str=default_str.in
...
test_run_program "Running pnFAM contour (this should take a couple of minutes at most)" \
   "$pnfam_path/$pnfam_exe $test_input_ctr1 >> $test_output_pnfam" \
   "There was an error running $pnfam_exe."

test_run_program "Running pnFAM contour (this should take a couple of minutes at most)" \
   "$pnfam_path/$pnfam_exe $test_input_ctr2 >> $test_output_pnfam" \
   "There was an error running $pnfam_exe."
