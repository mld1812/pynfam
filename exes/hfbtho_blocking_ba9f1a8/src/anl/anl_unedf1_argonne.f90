...
Program compute_energy
  ...
  use HFBTHO_solver
  Implicit None
  integer ierr,ios,output
  logical singleproc,verbose
  character(len=50) :: comp_filename
  character(len=50) :: chi2_filename
  double precision f,x(15),fval,egt,t
  integer :: bufsize,icom_err,i,gsi,sdi
  integer :: blocklen(7),types(7)
  integer :: mpibase, disp(7)
  integer :: ioflag
  ...
  close(801)
  comp_filename =  'UNEDF1Argonne_hfbtho.dat'
  chi2_filename =  'UNEDF1Argonne_chi2.dat'
