% formquads.m, Version 0.1, Modified 3/2/10
% Stefan Wild and Jorge More', Argonne National Laboratory.
% 
%  [Mdir,np,valid,G,H,Mind] = formquads(X,F,delta,xkin,npmax,Pars,vf)
%
...
%
function [Mdir,np,valid,G,H,Mind] = formquads(X,F,delta,xkin,npmax,Pars,vf)
